...
export class AddedAll1718462463366 implements MigrationInterface {
    name = 'AddedAll1718462463366'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "coupon" ("id" SERIAL NOT NULL, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "title" character varying NOT NULL, "description" character varying NOT NULL, "tagLine" character varying NOT NULL, "code" character varying, "startDate" TIMESTAMP NOT NULL, "expireDate" TIMESTAMP NOT NULL, "featured" boolean NOT NULL DEFAULT false, "categoryId" integer NOT NULL, "subCategoryId" integer NOT NULL, "storeId" integer NOT NULL, "imageName" character varying NOT NULL, "verified" boolean NOT NULL DEFAULT false, "exclusive" boolean NOT NULL DEFAULT false, "status" "public"."coupon_status_enum" NOT NULL, "isDeal" boolean NOT NULL, "seoId" integer, CONSTRAINT "REL_b36020792e47d3279a202448e3" UNIQUE ("seoId"), CONSTRAINT "PK_fcbe9d72b60eed35f46dc35a682" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TYPE "public"."store_status_enum" AS ENUM('enabled', 'disabled', 'pending')`);
        await queryRunner.query(`CREATE TABLE "store" ("id" SERIAL NOT NULL, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "title" character varying NOT NULL, "description" character varying NOT NULL, "imageName" character varying NOT NULL, "featured" boolean NOT NULL DEFAULT false, "status" "public"."store_status_enum" NOT NULL, "seoId" integer, CONSTRAINT "REL_3e6a5c65355e83f111cb86141e" UNIQUE ("seoId"), CONSTRAINT "PK_f3172007d4de5ae8e7692759d79" PRIMARY KEY ("id"))`);
