...
export class New1717350307395 implements MigrationInterface {
    name = 'New1717350307395'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "store" ("id" SERIAL NOT NULL, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "title" character varying NOT NULL, "description" character varying NOT NULL, "imageName" character varying NOT NULL, "featured" boolean NOT NULL DEFAULT false, "status" "public"."store_status_enum" NOT NULL, "seoId" integer, "affiliateLinkId" integer, CONSTRAINT "REL_3e6a5c65355e83f111cb86141e" UNIQUE ("seoId"), CONSTRAINT "REL_9790ee69a2507f89f9225df6a6" UNIQUE ("affiliateLinkId"), CONSTRAINT "PK_f3172007d4de5ae8e7692759d79" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`CREATE TABLE "affiliate_link" ("id" SERIAL NOT NULL, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "link" character varying NOT NULL, "merchant" character varying, "trackLink" character varying, "apiKey" character varying, "clicks" integer NOT NULL, CONSTRAINT "PK_4d8e59b42a53f7718de5c0a8002" PRIMARY KEY ("id"))`);
